    ...
    try {
        ...
        if(user){
            ...
            if(verifyUser){
                ...
                let token= jwt.sign(payload,'siliconMERNCourse',{expiresIn:36000})//secret key,after one hour new authorization/token is needed to be generated, for security purpose like net banking
                res.status(200).json({
                    message:`Logged In`,
